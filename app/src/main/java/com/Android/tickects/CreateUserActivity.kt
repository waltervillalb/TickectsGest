                ...
                val options = PhoneAuthOptions.newBuilder(auth)
                    ...
                    .setCallbacks(object : PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
                        ...
                        override fun onCodeSent(
                            ...
                            // Mostrar el diálogo o realizar otras operaciones después de enviar el código de verificación
                            dialog.show()
                        }
                    })
                    .build()
        ...
        FirebaseAuth.getInstance().signInWithCredential(credential)
            .addOnCompleteListener { task ->
                if (task.isSuccessful) {
                    val boton = findViewById<Button>(R.id.btn_CrearUsuario)
                    val boton2 = findViewById<Button>(R.id.btn_validar)
                    boton.visibility = View.VISIBLE
                    boton2.visibility= View.GONE
                    // La verificación del código SMS fue exitosa
